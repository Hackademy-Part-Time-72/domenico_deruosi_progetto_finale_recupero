...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <article class="card-custom p-0 overflow-hidden shadow-sm bg-white">
                @if($article->thumbnail)
                <img src="{{ $article->thumbnail }}" class="img-fluid w-100" alt="{{ $article->title }}" style="max-height: 400px; object-fit: cover;">
                @endif
                <div class="p-5">
                    <header class="mb-4">
