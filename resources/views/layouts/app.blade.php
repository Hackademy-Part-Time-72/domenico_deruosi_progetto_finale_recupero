                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('articles.index') ? 'active' : '' }}" href="{{ route('articles.index') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-speedometer2 me-1" viewBox="0 0 16 16">
                                        <path d="M8 4a.5.5 0 0 1 .5.5V6a.5.5 0 0 1-1 0V4.5A.5.5 0 0 1 8 4zM3.732 5.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707zM2 10a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 10zm7 5a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H9.5a.5.5 0 0 1-.5-.5zm5-5a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1h-1.5a.5.5 0 0 1-.5-.5zm-4.268-4.268a.5.5 0 0 1 0 .707l-.914.915a.5.5 0 1 1-.707-.708l.914-.914a.5.5 0 0 1 .707 0zm-1.5 8.514a.5.5 0 0 1 0-.707l.914-.915a.5.5 0 1 1 .707.708l-.914.914a.5.5 0 0 1-.707 0z"/>
                                        <path d="M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
                                        <path d="M0 10a8 8 0 1 1 15.547 2.661c-.442 1.253-1.845 1.602-2.932 1.25l-1.173-.394a.5.5 0 0 1 .51-.949l1.174.394c.533.179 1.125-.062 1.39-.56.316-.595.582-1.246.774-1.912l-.148.048a.5.5 0 0 1-.304-.952l1.034-.334a.5.5 0 0 1 .608.332 7 7 0 1 0-14.733 4.582.5.5 0 1 1-.785.622A8 8 0 0 1 0 10z"/>
                                    </svg>
                                    Area Riservata
                                </a>
                            </li>
